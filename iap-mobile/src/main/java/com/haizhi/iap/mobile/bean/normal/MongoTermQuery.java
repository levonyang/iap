 ...
 */
@Data
public class MongoTermQuery extends AbstractMongoQuery
{
    @Builder
    public MongoTermQuery(String table, Integer offset, Integer size, List<String> projections, List<Sort> sorts, Pair<String, Object> query)
    {
    ...
    public Bson toFilter()
    {
        ...
        if(query != null)
            filterBson = Filters.and(Filters.eq(query.getLeft(), query.getRight()), filterBson);
        return filterBson;
    }
}
