...
public class GraphEdgeLabelUtil
{
    ...
    public void init()
    {
        EDGE_LABEL_MAKER_MAP.put(EdgeCollection.INVEST.getTableName(), investLabelMaker);
        EDGE_LABEL_MAKER_MAP.put(EdgeCollection.TRADABLE_SHARE.getTableName(), tradableShareLabelMaker);
        EDGE_LABEL_MAKER_MAP.put(EdgeCollection.ACTUAL_CONTROLLER.getTableName(), actualControllerLabelMaker);
        EDGE_LABEL_MAKER_MAP.put(EdgeCollection.CONTROL_SHAREHOLDER.getTableName(), controlShareHolderLabelMaker);
    }
    ...
    public static abstract class EdgeLabelMaker
    {
        ...
        public EdgeLabelMaker(EdgeCollection edgeCollection)
        {
        ...
        {
            if(GraphEdgeLabel.EDGE_LABEL_CONF_MAP.containsKey(edgeCollection.getTableName()))
                return GraphEdgeLabel.EDGE_LABEL_CONF_MAP.get(edgeCollection.getTableName()).getTableCnName();
            return EdgeCollection.INVEST.getTableName();
        }
    ...
    public static class TradableShareLabelMaker extends EdgeLabelMaker
    {
        ...
        {
            super(EdgeCollection.TRADABLE_SHARE);
        }
    ...
    public static class ActualControllerLabelMaker extends EdgeLabelMaker
    {
        ...
        {
            super(EdgeCollection.ACTUAL_CONTROLLER);
        }
    ...
    public static class ControlShareHolderLabelMaker extends EdgeLabelMaker
    {
        ...
        {
            super(EdgeCollection.CONTROL_SHAREHOLDER);
        }
