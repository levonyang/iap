 ...
 */
public class RegistorCapitalChangeNotification extends Notification {

    public RegistorCapitalChangeNotification() {
    ...
    @Override
    public int getType() {
        return NotificationType.RISK_REGISTOR_CAPITAL_CHANGE.getCode();
    }
}
